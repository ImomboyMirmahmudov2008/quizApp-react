...
class Play extends React.Component {
    ...
    componentDidMount() {
        ...
        // axios.get("https://opentdb.com/api.php?amount=10").then((res)=>this.setState({questions:res.data.results})).catch((err)=>console.log(err))
            ...
            <Fragment>
                ...
                <div className="questions">
                    ...
                    <div className='lifeline-container'> 
                        <p>
                            <span onClick={this.handleFiftyFifty} className="lifeline">Ellik-ellik: {fiftyFifty}</span>
                        </p>
                        <p>
                    ...
                    <div className="button-container">
                        <button className={classNames('', {'disable': this.state.previousButtonDisabled})} id="previous-button" onClick={this.handleButtonClick}>Qaytish</button>
                        <button className={classNames('', {'disable': this.state.nextButtonDisabled})} id="next-button" onClick={this.handleButtonClick}>Keyingisi</button>
                        <button id="quit-button" onClick={this.handleButtonClick}>Chiqish</button>
